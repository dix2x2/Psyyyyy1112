...
export default function ResearchStandards() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      >
        <h1 className="text-4xl font-serif text-stone-900 dark:text-stone-50 mb-6 transition-colors">{t('researchStandards.title')}</h1>
        <p className="text-2xl text-stone-700 dark:text-stone-300 mb-12 leading-relaxed transition-colors">
          {t('researchStandards.subtitle')}
        </p>

        <div className="space-y-8 text-lg text-stone-800 dark:text-stone-300 leading-relaxed transition-colors">
          <p>{t('researchStandards.p1')}</p>
          <p>{t('researchStandards.p2')}</p>
          <p>{t('researchStandards.p3')}</p>
        </div>
      </motion.div>
    </div>
  );

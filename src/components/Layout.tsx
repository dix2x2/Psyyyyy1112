...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-stone-50 text-stone-900 font-sans dark:bg-stone-900 dark:text-stone-50 transition-colors duration-200">
      <header className="border-b border-stone-200 dark:border-stone-800 bg-white/80 dark:bg-stone-900/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 text-stone-900 dark:text-stone-50 hover:text-stone-600 dark:hover:text-stone-300 transition-colors">
            <BrainCircuit className="w-6 h-6 text-emerald-700 dark:text-emerald-500" />
            <span className="font-serif text-xl font-semibold tracking-wide">Psychometrics<span className="text-emerald-700 dark:text-emerald-500">Pro</span></span>
          </Link>
          <div className="flex items-center gap-6">
            <nav className="flex gap-6">
              <Link to="/tests" className="text-base font-medium text-stone-700 dark:text-stone-300 hover:text-stone-900 dark:hover:text-stone-100 flex items-center gap-1.5 transition-colors">
                <FileText className="w-5 h-5" />
                {t('nav.assessments')}
              </Link>
              <Link to="/methodology" className="text-base font-medium text-stone-700 dark:text-stone-300 hover:text-stone-900 dark:hover:text-stone-100 flex items-center gap-1.5 transition-colors">
            ...
            <div className="flex items-center gap-3 border-l border-stone-200 dark:border-stone-700 pl-6">
              <Link 
                to="/profile"
                className="p-1.5 text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100 transition-colors rounded-full hover:bg-stone-100 dark:hover:bg-stone-800"
                title={t('nav.profile')}
              >
              ...
              <button 
                ...
                className="flex items-center gap-1.5 text-sm font-medium text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100 transition-colors"
      ...
      <footer className="bg-stone-900 dark:bg-black text-stone-400 py-12 mt-24">
